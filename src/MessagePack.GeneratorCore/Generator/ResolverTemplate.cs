...
namespace ");
            ...
            this.Write(" : global::MessagePack.IFormatterResolver\n    {\n        public static readonly gl" +
                    "obal::MessagePack.IFormatterResolver Instance = new ");
            this.Write(this.ToStringHelper.ToStringWithCulture(ResolverName));
            this.Write("();\n\n        private ");
            this.Write(this.ToStringHelper.ToStringWithCulture(ResolverName));
            this.Write(@"()
    ...
    internal static class ");
            this.Write(this.ToStringHelper.ToStringWithCulture(ResolverName));
            this.Write("GetFormatterHelper\n    {\n        private static readonly global::System.Collectio" +
                    "ns.Generic.Dictionary<Type, int> lookup;\n\n        static ");
            this.Write(this.ToStringHelper.ToStringWithCulture(ResolverName));
            this.Write("GetFormatterHelper()\n        {\n            lookup = new global::System.Collection" +
                    "s.Generic.Dictionary<Type, int>(");
